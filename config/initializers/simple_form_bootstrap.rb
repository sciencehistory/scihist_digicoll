...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.use :placeholder
  ...
  # vertical file input
  config.wrappers :vertical_file, class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :vertical_select, class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-label'
    b.use :hint, wrap_with: { class: 'form-text scihist-hint mb-2 mt-0' }
  ...
  config.wrappers :vertical_multi_select, class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-label'
    b.use :hint, wrap_with: { class: 'form-text scihist-hint mb-2 mt-0' }
  ...
  config.wrappers :vertical_range, class: 'form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  config.wrappers :horizontal_form, class: 'row form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_boolean, class: 'row form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label', class: 'row form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label', class: 'row form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label pt-0'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_file, class: 'row form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_select, class: 'row form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_multi_select, class: 'row form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
  ...
  config.wrappers :horizontal_range, class: 'row form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  config.wrappers :floating_labels_form, class: 'form-floating form-group',error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  # custom multi select
  config.wrappers :floating_labels_select, class: 'form-floating form-group', error_class: 'form-group-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :input, class: 'form-select', error_class: 'is-invalid'
    b.use :label
