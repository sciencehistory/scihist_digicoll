select
    ...
    COALESCE (
        LEFT(field_interviewee_death_date_value, 10),  -- YYY-MM-DD
        LEFT(field_death_date_month_year_value,   7),  -- YYYY-MM
        LEFT(field_death_date_year_only_value,    4)   -- YYYY
    ) death_date,
...
LEFT JOIN
    field_data_field_death_date_month_year target_table_1
    ON
...
LEFT JOIN
    field_data_field_death_date_year_only target_table_2
    ON
...
LEFT JOIN
    field_data_field_interviewee_death_date target_table_3
    ON
