  ...
  self.definitions = {
    ...
    color: {
      ...
      subject: [
        ...
        "Colorfastness (Textiles)--Testing",
        "Colorimetry",
        ...
        "Dyes and dyeing--Glass fibers",
        "Dyes and dyeing--History",
        "Dyes and dyeing--Hosiery",
        "Dyes and dyeing--Knit goods",
        "Dyes and dyeing--Leather",
        "Dyes and dyeing--Nylon",
        "Dyes and dyeing--Paper",
        "Dyes and dyeing--Plastics",
        "Dyes and dyeing--Rayon",
        "Dyes and dyeing--Religious aspects",
        "Dyes and dyeing--Rubber goods",
