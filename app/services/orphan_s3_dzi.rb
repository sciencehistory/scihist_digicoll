...
class OrphanS3Dzi
  ...
  #     {bucket_prefix}{asset uuid}/md5_{expected_md5}.dzi
  #     {bucket_prefix}{asset uuid}/md5_{expected_md5}_files/
  def expected_second_level_folder_pattern(asset)
    expected_md5 = asset.file_data['metadata']['md5']     
    expected_pattern_for_second_level_folders = /^#{bucket_prefix}#{asset.id}\/md5_#{expected_md5}(\.dzi|_files\/)$/
  end
