...
Search.onSearchSubmit = function(event) {
  ...
  $("*[data-ohms-hitcount='transcript']").html('<span class="badge badge-pill text-bg-danger">' + transcriptResults.length + '</span>');
  ...
  $("*[data-ohms-hitcount='index']").html('<span class="badge badge-pill text-bg-danger">' + indexResults.length + '</span>');
