namespace :scihist do
  namespace :data_fixes do
    ...
    task :fix_beckman_heading => :environment do
      total = Work.jsonb_contains("creator.value" =>  "Beckman Instruments, inc.").count +
        Work.jsonb_contains("subject" =>  "Beckman Instruments, Inc.").count +
        Work.jsonb_contains("subject" =>  "Beckman Instruments, inc. Spinco Division").count
      ...
      Kithe::Indexable.index_with(batching: true) do
        ...
        Work.jsonb_contains("subject" =>  "Beckman Instruments, inc. Spinco Division").find_each do |work|
          work.subject.collect! { |s| s == "Beckman Instruments, inc. Spinco Division" ? "Beckman Instruments, Inc. Spinco Division" : s}
          work.save!
