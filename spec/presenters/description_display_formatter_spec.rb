  ...
  describe "no truncation" do
    {
      ...
      "Turns email address into link nobody@example.com" => '<p>Turns email address into link <a href="mailto:nobody@example.com"><i class="fa fa-external-link" aria-hidden="true"></i>&nbsp;nobody@example.com</a></p>',
